...
static const uint256 hashGenesisBlock("0x000006dc30acfc1c308235b8ef0491a7efc5fe5df8c4a9dbf2f73f7fa60bcd65");
static const uint256 hashGenesisBlockTestNet("0x000006dc30acfc1c308235b8ef0491a7efc5fe5df8c4a9dbf2f73f7fa60bcd65");
...
public:
    ...
    {
        // AcesPro: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // AcesPro: get transaction coin age
...
public:
    ...
    // AcesPro: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // AcesPro: two types of block: proof-of-work or proof-of-stake
    ...
    // AcesPro: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // AcesPro: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // AcesPro: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // AcesPro: block index flags
    enum  
    {
